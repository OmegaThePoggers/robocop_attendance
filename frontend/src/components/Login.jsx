        ...
        <div className="min-h-[80vh] flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8 relative z-10 w-full animate-fade-in">
            ...
            <div className="max-w-md w-full glass-panel-heavy p-8 sm:p-10 relative overflow-hidden">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 shadow-lg shadow-primary-500/20 mb-6 mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                    ...
                    <p className="text-center text-sm text-dark-muted mt-6">
                        ...
                        <button type="button" onClick={() => navigate('/register')} className="text-primary-400 hover:text-primary-300 font-medium transition-colors">
                            Register now
                        </button>
                    </p>
                </form>
